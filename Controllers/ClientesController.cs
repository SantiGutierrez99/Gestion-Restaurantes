...
namespace obligatorio2024.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public ClientesController(Obligatorio2024Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Email,Telefono,TipoCliente")] Cliente cliente)
        {
